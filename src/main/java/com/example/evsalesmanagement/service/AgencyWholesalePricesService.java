...
public class AgencyWholesalePricesService {
    ...
    public AgencyWholesalePriceResponseDTO createAgencyWholesalePrice(AgencyWholesalePriceDTO agencyWholesalePriceDTO) {
        ...
        Agency agency = agencyRepository.findById(agencyWholesalePriceDTO.getAgencyId())
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Không tìm thấy Agency với ID: " + agencyWholesalePriceDTO.getAgencyId()));
        ...
        VehicleTypeDetail vehicleTypeDetail = vehicleTypeDetailRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException("Không tìm thấy VehicleTypeDetail với ID: "
    ...
    public AgencyWholesalePriceResponseDTO getByIdAgencyWholesalePrice(Integer agencyWholesalePriceId) {
        AgencyWholesalePrice price = agencyWholesalePriceRepository.findById(agencyWholesalePriceId)
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Không tìm thấy AgencyWholesalePrice với ID: " + agencyWholesalePriceId));
    ...
    public AgencyWholesalePriceResponseDTO updateAgencyWholesalePrice(Integer agencyWholesalePriceId,
        ...
        VehicleTypeDetail vehicleTypeDetail = vehicleTypeDetailRepository
                ...
                .orElseThrow(() -> new ResourceNotFoundException(
                        "Không tìm thấy VehicleTypeDetail với ID: " + agencyWholesalePrice.getVehicleTypeDetailId()));
        ...
        agencyWholesalePriceResponseDTO.setVehicleTypeDetail(new VehicleTypeDetailResponseDTO(vehicleTypeDetail));
        return agencyWholesalePriceResponseDTO;
